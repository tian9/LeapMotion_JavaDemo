...
class DrawMultiFigure extends JFrame implements ActionListener{
	...
	private static JLabel lblGesture;
	...
	public static void frameDesign(){
		...
		meassageShowPanel(panelShow, txtpnInstruction, lblResultsYouHave, lblGesture, lblSample);
	...
	private static void meassageShowPanel(JPanel panelShow, 
			JTextPane txtpnInstruction, JLabel lblResultsYouHave, JLabel lblGesture, JLabel lblSample){
